...
<div class="wrapper">
	<header class="header">
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-12 col-xs-12 site-logo" style='margin-top:12px;font-size:20px;color:#808080;font-weight:300;font-family:"Roboto Condensed", sans-serif;letter-spacing:3px;'>
					JP. Aulet Blog <?php //xclean_logo(); ?>
				</div><!-- End .header-logo -->
